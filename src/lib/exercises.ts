...
export const EXERCISES: Exercise[] = [
  ...
  { id: "prone-neck-extension", name: "Prone Neck Extension", category: "Neck", musclesWorked: ["Neck", "Traps"], description: "Lying face down with the head off the end of a bench, raise it from chin-down to level. The step before loading neck extension.", isBodyweight: true },
  { id: "supine-neck-flexion", name: "Supine Neck Flexion", category: "Neck", musclesWorked: ["Neck"], description: "Lying face up with the head off the end of a bench, curl the chin toward the chest. The step before loading neck flexion.", isBodyweight: true },
